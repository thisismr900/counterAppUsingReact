...
function App() {
  ...
  function decreaseHandler(){
    // count=count-1;   re-render on UI nhi hoga
    setCount(count-1);  //ab hoga
  }
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10">
      ...
      <div className="flex bg-white flex-row justify-center gap-12 py-3 rounded-sm text-[25px] text-[#344151]">
